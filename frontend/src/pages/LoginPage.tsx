    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#020408] text-white">
      <div className="w-full max-w-md p-8 rounded-xl bg-surface/50 border border-border/50 backdrop-blur-md shadow-2xl">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-cyan-400">Terminal Login</h2>
          <p className="text-sm text-gray-400 mt-2">Authenticate to access A.L.I.E.</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          No clearance? <Link to="/register" className="text-cyan-400 hover:underline">Request Access</Link>
        </div>
      </div>
    </div>
  );
